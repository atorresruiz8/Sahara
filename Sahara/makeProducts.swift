...
class ProductCreator{
    ...
    let tags = [["Outdoors", "Decorations"],["Outdoors", "Cooking", "Decorations"], ["Electronics", "Decorations"], ["Electronics", "Decorations"], ["Clothing", "Decorations"], ["Electronics", "Decorations"], ["Cooking", "Decorations"], ["Electronics", "Outdoors", "Clothing", "Cooking", "Decorations"], ["Clothing", "Decorations"], ["Clothing", "Decorations"], ["Decorations"], ["Electronics", "Decorations"], ["Electronics", "Decorations"],  ["Clothing", "Decorations"], ["Decorations"], ["Electronics", "Outdoors", "Decorations"], ["Electronics", "Outdoors", "Decorations"],  ["Electronics", "Decorations"], ["Outdoors", "Decorations"], ["Electronics", "Decorations"], ["Electronics", "Decorations"], ["Electronics", "Decorations"], ["Outdoors", "Cooking", "Decorations"], ["Outdoors", "Decorations"], ["Outdoors", "Decorations"], ["Decorations"], ["Decorations"], ["Electronics", "Decorations"], ["Electronics", "Cooking", "Decorations"], ["Electronics", "Decorations"]]
    func remakeAll(){
        //DBHelper.inst.clearProducts()
        for i in 1...names.count{
            DBHelper.inst.addProduct(price: origPrice[i-1], name: names[i-1], tags: tags[i-1], sale : sale[i-1], salePerc : salePercent[i-1], image : images[i-1])
